...
int main(int argc, char** argv)
{
	...
	*/
	...
	case 1:
		//Change to ricco
		loadFilename = "untrackedmodels/dragon.ply";	//"untrackedmodels/Craspedia2.ply";	// "untrackedmodels/Helianthus4.ply";	//"untrackedmodels/GRCD2RNA.ply";	//"models/Cube.obj";	//"models/icosahedron.ply";
